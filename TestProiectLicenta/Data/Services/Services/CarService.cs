...
namespace TestProiectLicenta.Data.Services
{
    public class CarService : ICarService
    {
        ...
        public async Task<List<Car>> GetCarsAsync(bool force = false)
        {
            var url = Constants.webAPI + "Cars/All";
        ...
        public async Task<Car> GetCar(int carId, bool force = false)
        {
        ...
        public async Task<List<Car>> GetUserCars(int userId, bool force = false)
        {
